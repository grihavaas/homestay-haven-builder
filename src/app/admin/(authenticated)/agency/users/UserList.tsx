          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
                    ...
                    <td className="px-4 py-3 text-right">
                      {isCurrentUser ? (
                        ...
                        <button
                          ...
                          className="text-xs text-red-600 hover:underline disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-1"
                        >
                          {isDeleting ? (
                            <>
              ...
              {membershipList.length === 0 && (
                <tr>
                  <td colSpan={4} className="px-4 py-3 text-sm text-zinc-600">
                    No assignments yet.
                  </td>
                </tr>
              )}
...
function AssignRow({
  ...
  return (
    <tr className={isAssigning ? "opacity-50" : ""}>
      <td className="px-4 py-3">
      ...
      <td className="px-4 py-3 text-right">
        <button
          ...
          className="text-xs text-blue-600 hover:underline disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-1"
        >
          {isAssigning ? (
            <>
              <Loader2 className="w-3 h-3 animate-spin" />
